...
| First-line HCC systemic therapy | Current NCCN recs with citations | Incomplete | Incomplete | FDA-rejected drug<sup>2</sup> | China-only drug | Incomplete |
...
| Adjuvant Stage III melanoma (BRAF V600+) | Current guideline recs with page refs | Partially correct | Partially correct | Partially correct | Partially correct | Partially correct |
...
- **Negative knowledge:** NCCN guidelines are updated to reflect withdrawals; structured navigation ensures current content
- **Geographic confusion:** NCCN guidelines are U.S.-specific by definition; the system operates within a single regulatory framework
